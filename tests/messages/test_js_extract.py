...
msg3 = ngettext('s', 'p', 42)
    ...
    assert messages == [(1, 'simple', [], None, ("javascript-format", )),
                        (2, 'simple', [], None, ("javascript-format", )),
                        (3, ('s', 'p'), [], None, ("javascript-format", ))]
...
""")
    messages = \
        list(extract.extract('javascript', buf, extract.DEFAULT_KEYWORDS, [],
                             {}))
    assert messages == [
        (5, (u'bunny', u'bunnies'), [], None, ("javascript-format", )),
        (8, u'Rabbit', [], None, ("javascript-format", )),
        (10, (u'Page', u'Pages'), [], None, ("javascript-format", ))
    ]
...
def test_dotted_keyword_extract():
    ...
    assert messages == [(1, 'Insert coin to continue', [], None, ("javascript-format", ))]
...
def test_template_string_standard_usage():
    ...
    assert messages == [(1, 'Very template, wow', [], None, ("javascript-format", ))]
...
def test_template_string_tag_usage():
    ...
    assert messages == [(1, 'Tag template, wow', [], None, ("javascript-format", ))]
